...
import read.eyydf.terr.jokecollection.tools.FontCustom;

/**
 * @author ccheng
 * @Date 3/18/14
 */
public class JustifyEditTextView extends EditText {
	...
	public JustifyEditTextView(Context context, AttributeSet attrs) {
		super(context, attrs);
		paint = getPaint();
