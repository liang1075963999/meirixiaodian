        ...
        tijiao.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!editText.getText().toString().equals("")) {
                    DownJson1 downJson = new DownJson1(20, 3, -1, -1, -1, DataLocalSave.getString(NiChengActivity.this, "zhanghao"), DataLocalSave.getString(NiChengActivity.this, "mima"), ActivityUtils.uerid, -1, -1, 2, editText.getText().toString());
                                ...
                                if (tag.equals("ready")) {
                                 ...
                                 /*   wenzi.setText(jsonObject.getJSONObject("user").getString("nickname"));
                                    qianming.setText(jsonObject.getJSONObject("user").getString("signature"));*/
                                        ...
                                        LocalBroadcastManager.getInstance(NiChengActivity.this).sendBroadcast(login);
                                        finish();
                                    }
                    ...
                    Toast.makeText(NiChengActivity.this, "昵称不能为空", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
