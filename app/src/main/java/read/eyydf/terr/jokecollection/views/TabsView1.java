 ...
 *
 */
public class TabsView1 extends LinearLayout {
    ...
    public TabsView1(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public TabsView1(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mIndicator.setImageResource(R.mipmap.gerendibu);
        mIndicator.setScaleX(3);
        mIndicator.setScaleY(1.5f);
        mIndicator.setLayoutParams(new LayoutParams(300, DeviceUtils.dip2px(context, 3.0f)));// 先任意设置宽度
        MarginLayoutParams marginLayoutParams= (MarginLayoutParams) mIndicator.getLayoutParams();
        marginLayoutParams.bottomMargin=15;
        mIndicator.setLayoutParams(marginLayoutParams);
        addView(mIndicator);
        // 初始化底部横线
