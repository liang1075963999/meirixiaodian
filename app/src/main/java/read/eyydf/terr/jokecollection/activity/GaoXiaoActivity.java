 ...
 */
@ContentView(R.layout.activity_gaoxiao)
public class GaoXiaoActivity extends BaseActivity {
    ...
    public void init() {
        ...
        DownJson1 downJson = new DownJson1(36, 2, -1, -1, index, null, null, -1, -1, -1,2);
            ...
            public void jsonLoaded(String[] json, String tag) {
                if (tag.equals("ready")) {
                    try {
                       ...
                       // DownJson downJson1 = new DownJson(2, 3, -1, -1, 1, null, null, -1, -1, -1);
                        DownJson1 downJson1 = new DownJson1(36, 2, -1, -1, index, null, null, -1, -1, -1,2);
    ...
    private void listViewSet() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
                ...
                Log.d("GaoXiaoActivity", "你点击的是" + arg2);
                click_xiaohua(arg2);
            }
        });
    }
    ...
    private void load_more() {
       // DownJson downJson1 = new DownJson(2, 3, -1, -1, index, null, null, -1, -1, -1);
        DownJson1 downJson1 = new DownJson1(36, 2, -1, -1, index, null, null, -1, -1, -1,2);
        downJson1.FreedomLoadTask(new DownJson.FreedomCallback() {
            @Override
            public void jsonLoaded(String[] json, String tag) {
                if (tag.equals("ready")) {
                    ...
                    try {
                        ...
                        if (articlelist.length() == 0) {
                            ...
                            Toast.makeText(GaoXiaoActivity.this, "已加载所有数据!", Toast.LENGTH_SHORT).show();
                            return;
                        }
                        for (int i = 0; i < articlelist.length(); i++) {
                            GetListData paihangListData = new GetListData();
    ...
    private void click_xiaohua(int position) {
            ...
            for (int i = 0; i < zuixinListDatas.size(); i++) {
                ...
                Log.d("ididid", "zuixinListDatas.get(i).getArticle_id():" + zuixinListDatas.get(i).getArticle_id());
